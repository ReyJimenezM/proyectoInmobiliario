...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/solicitudes", label: "Solicitudes", icon: IconInbox, roles: null },
      { href: "/admin/pipeline", label: "Pipeline", icon: IconGrid, roles: null },
      { href: "/admin/leads", label: "Leads / CRM", icon: IconUsers, roles: null },
      { href: "/admin/contratos", label: "Contratos", icon: IconDocCheck, roles: null },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/roles", label: "Roles y permisos", icon: IconShield, roles: ["super_admin"] },
      { href: "/admin/formularios", label: "Formularios", icon: IconDocCheck, roles: ["super_admin"] },
      { href: "/admin/pagos", label: "Pagos y facturación", icon: IconScales, roles: ["admin", "super_admin"] },
      { href: "/admin/notificaciones", label: "Notificaciones", icon: IconBell, roles: ["admin", "super_admin"] },
